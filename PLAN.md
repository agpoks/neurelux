...
| TEAM Workshop Problem 7 | https://www.compumag.org/wp/wp-content/uploads/2018/06/problem7.pdf | Official spec: real geometry/material/excitation for an eddy-current benchmark | sigma, thickness, coil AT, frequencies (real; no reference field values — see below) | freely published benchmark spec | Yes (`scripts/download_team7.py`) | 05 | Real material/frequency parameters for the classical skin-effect solution used as Notebook 05's reference — the companion results paper with the original reference field measurements was not accessible from this environment; not used or invented |
| TEAM Workshop Problem 28 | https://www.compumag.org/jsite/images/stories/TEAM/problem28.pdf | Real geometry/excitation **and** a full 174-point real experimental measurement of levitation height vs. time | t, z (real, laser-triangulation-measured) | freely published research paper | Yes (`scripts/download_team28.py`) | 06 | Closest public analogue to ATLAS's velocity/motion-coupled eddy-current problem — real measured mechanical trajectory, used directly as Notebook 06's only training/evaluation data |
...
2. TEAM 7's own reference field measurements (the companion COMPEL 1990 results paper) were not accessible from this environment — Notebook 05 uses TEAM7's real geometry/material/frequency parameters against the classical analytical skin-effect solution instead; revisit if that paper becomes available. TEAM 28's real measurement data was fully obtained and is in active use (Notebook 06).
