#!/usr/bin/env python3
"""Download a small subset of: TEAM Workshop Problem 28 (search: 'TEAM Problem 28 moving conductor') — no confirmed automatic-download source yet
...
DATASET_URL = "TEAM Workshop Problem 28 (search: 'TEAM Problem 28 moving conductor') — no confirmed automatic-download source yet"
TARGET_DIR = "data/public/team28"
