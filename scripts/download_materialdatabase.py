#!/usr/bin/env python3
"""Download a small subset of: https://github.com/upb-lea/materialdatabase
...
DATASET_URL = "https://github.com/upb-lea/materialdatabase"
TARGET_DIR = "data/public/materialdatabase"
